...
namespace Plugin.MediaManager.ExoPlayer
{
	...
	public class MyDefaultTrackSelector : DefaultTrackSelector
	{
		public MyDefaultTrackSelector(IntPtr intref, Android.Runtime.JniHandleOwnership owner) : base(intref, owner)
		{
		}

		public MyDefaultTrackSelector(Handler p0, ITrackSelectionFactory fact) : base(p0, fact)
		{

		}

		public MyDefaultTrackSelector(Handler p0) : base(p0)
		{
